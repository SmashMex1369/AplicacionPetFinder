...
class BusquedaEncuentroAdapter(private val publicacionesEncuentro:List<PublicacionEncontrado>, private var listenerPublicacion:ListenerRecyclerEncontrado):
    RecyclerView.Adapter<BusquedaEncuentroAdapter.PublicacionEncuentroViewHolder>() {
