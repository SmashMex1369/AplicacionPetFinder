...
class BusquedaExtravioAdapter(private val publicacionesExtravio:List<PublicacionExtravio>, private var listenerPublicacion:ListenerRecyclerExtraviado):
    RecyclerView.Adapter<BusquedaExtravioAdapter.PublicacionExtravioViewHolder>() {
